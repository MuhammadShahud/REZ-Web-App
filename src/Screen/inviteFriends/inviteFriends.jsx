...
import { Heading, RezNavbar, Button, InputField, DropDown, FollowCard } from "../../Components";
import {
    CalanderTabs,
    Footer,
} from "../../Containers";
...
const InviteFriends = () => {
    return (
        <div style={{ backgroundColor: "#fcfcfd", minHeight: "100vh" }}>
            ...
            <Heading text={'INVITE FRIENDS'} style={{ alignItems: 'center', margin: '40px 0' }} />

            <div className={styles.inviteFriends__main}>
                <div className={styles.inviteFriends__search}>
                    <SearchBar placeholder={'Search Now'} />
                </div>

                <div className={styles.inviteFriends__list}>
                    <List
