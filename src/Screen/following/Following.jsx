...
const Following = () => {
    ...
    return (
        <div style={{ backgroundColor: "#fcfcfd", minHeight: "100vh" }}>
            ...
            <Heading text={'Following'} style={{ alignItems: 'center', margin: '40px 0' }} />

            <div className={styles.following__main}>
                {/* <div className={styles.following__search}>
                    <SearchBar placeholder={'Search Now'} />
                </div> */}

                <div className={styles.following__list}>
                    <List
                        ...
                        renderItem={item => (
                            <List.Item>
                                <div className={styles.following__listContainer}>
                                    <FollowCard
                                        img={item.img}
                                        userName={item.name}
                                        buttonText={"UNFOLLOW"}
